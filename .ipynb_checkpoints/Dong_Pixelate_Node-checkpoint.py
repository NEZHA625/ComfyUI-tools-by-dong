...
class Dong_Pixelate_Node:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "images": ("IMAGE",),
                "pixelation_size": ("FLOAT", {"default": 160, "min": 16, "max": 480, "step": 1}),
    ...
    CATEGORY = "dong_tools/Pixelate_by_dong"

    def Pixelate(self, images, pixelation_size=164, num_colors=16, init_mode='random', max_iterations=100, color_palette_mode="Linear", reverse_palette='False', dither='False', dither_mode='FloydSteinberg'):
