...
class sora2:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "model": (["sora-2-image-to-video","sora-2-text-to-video"], {"default": "sora-2-text-to-video"}),
    ...
    def run(
        ...
        if not task_id:
            return ("", False, "suchuang 未返回 task_id")
